...
var contenedorChat = /*#__PURE__*/function () {
  function contenedorChat(chatOP, table) {
    _classCallCheck(this, contenedorChat);

    this.knex = knex(chatOP);
    this.table = table;
  }

  _createClass(contenedorChat, [{
    key: "save",
    value: function () {
      var _save = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(newDato) {
        var exist, res, result, _res, _result;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 7;
                return this.knex(this.table).insert(newDato);

              case 7:
                _context.t0 = JSON;
                _context.next = 10;
                return this.knex.from(this.table).select('*').orderBy('id', 'desc').limit(1);

              case 10:
                _context.t1 = _context.sent;
                res = _context.t0.stringify.call(_context.t0, _context.t1);
                result = JSON.parse(res);
                return _context.abrupt("return", result);

              case 16:
                _context.next = 18;
                return this.knex.schema.createTableIfNotExists('usuarios', function (table) {
              ...
              case 23:
                ...
                _res = _context.t2.stringify.call(_context.t2, _context.t3);
              ...
              case 29:
                ...
                console.log('Hubo un error al guardar el articulo', _context.t4);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                res = _context2.t0.stringify.call(_context2.t0, _context2.t1);
                result = JSON.parse(res);
              ...
              case 17:
                ...
                console.log('Hubo un error al mostrar la base de datos', _context2.t2);
