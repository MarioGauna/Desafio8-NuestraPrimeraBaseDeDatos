...
var contenedorProd = /*#__PURE__*/function () {
  function contenedorProd(prodOP, table) {
    _classCallCheck(this, contenedorProd);

    this.knex = knex(prodOP);
    this.table = table;
  }

  _createClass(contenedorProd, [{
    key: "save",
    value: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 16:
                _context.next = 18;
                return this.knex.schema.createTable('productos', function (table) {
